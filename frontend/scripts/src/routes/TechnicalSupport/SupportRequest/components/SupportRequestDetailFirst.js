...
class SupportRequestDetailFirst extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      initialData: {
    ...
    return (
      <div className="InputDetail_stepsContent" style={{ height: 660 }}>
        <Form onSubmit={this.handleSubmit} style={{ width: '80%', marginLeft: '10%', paddingBottom: 50 }}>
          ...
          <div style={{ marginBottom: 20, marginTop: 20, marginLeft: '3%', width: '90%', height: 50, backgroundColor: '#edf7fc', lineHeight: '50px', paddingLeft: 20 }}>技术保障软件信息</div>
          {this.props.disable ?
            <Row>
              <Col span={12}>
                <FormItem
        ...
        {this.props.disable &&
          <div style={{ fontSize: 16, padding: 10, width: '80%', marginLeft: '10%', border: '1px solid #ccc', marginTop: 20 }}>
            <div style={{ marginBottom: 20, marginTop: 20, marginLeft: '3%', width: '90%', height: 50, backgroundColor: '#edf7fc', paddingLeft: 20 }}>
              <span>汇总信息</span>
              <div style={{ overflow: 'hidden', display: 'inline-block', position: 'relative', top: 5, width: '90%', marginLeft: 30 }}>
...
SupportRequestDetailFirst.propTypes = {
  form: PropTypes.object.isRequired,
  disable: PropTypes.bool.isRequired,
};
const WrapSupportRequestDetailFirst = Form.create()(SupportRequestDetailFirst);
export default WrapSupportRequestDetailFirst;
