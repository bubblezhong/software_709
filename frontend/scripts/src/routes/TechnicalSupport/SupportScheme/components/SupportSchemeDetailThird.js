...
import SupportSchemeDetailThirdStaticData from './SupportSchemeDetailThirdStaticData';
// import { json2table } from './json2table';


const Search = Input.Search;
class SupportSchemeDetailThird extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editState: false,
    ...
    return (
      <div className="InputDetail_stepsContent">
        <div style={{ width: '80%', marginLeft: '12%', minHeight: 500, marginTop: 20 }}>
          ...
          <SupportSchemeDetailThirdStaticData />
...
export default SupportSchemeDetailThird;
