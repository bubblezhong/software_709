...
class SupportSchemeDetailSecond extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showTask: false,
...
SupportSchemeDetailSecond.propTypes = {
  // disable: PropTypes.bool.isRequired,
  form: PropTypes.object.isRequired,
};
const WrapSupportSchemeDetailSecond = Form.create()(SupportSchemeDetailSecond);
export default WrapSupportSchemeDetailSecond;
