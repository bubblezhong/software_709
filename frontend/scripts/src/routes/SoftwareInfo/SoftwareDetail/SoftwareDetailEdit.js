...
class SoftwareDetailEdit extends React.Component {
    ...
    if (this.state.addNewStatus) {
      ...
      this.props.form.validateFields((err, values) => {
        if (!err) {
          ...
          console.log('values.INSTALLPOS', values.INSTALLPOS, values.SU_SYSTEM);
          values.INSTALLPOS = values.INSTALLPOS.join(',');
          values.SW_SYSTEM = values.SW_SYSTEM.join(',');
  ...
  render() {
    ...
    // let moduleIdStr;
    // if (initialData.MODULE_ID !== undefined) {
    //   moduleIdStr = initialData.MODULE_ID.toString();
    // }
    // let developUnitId;
    // if (initialData.DEPARTMENT_ID !== undefined) {
    //   developUnitId = initialData.DEPARTMENT_ID.toString();
    // }
    // let ownerId;
    // if (initialData.SW_OWNER !== undefined) {
    //   ownerId = initialData.SW_OWNER.toString();
    // }
    // console.log('developUnitId', ownerId);
    return (
      <div>
