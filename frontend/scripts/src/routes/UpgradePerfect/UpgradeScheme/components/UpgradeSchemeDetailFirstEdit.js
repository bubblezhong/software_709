...
import { Modal, Table, Select, TreeSelect, Button, Form, Input, Row, Upload, Icon, Col } from 'antd';

const FormItem = Form.Item;
const Search = Input.Search;
const ButtonGroup = Button.Group;
class UpgradeSchemeDetailFirstEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showRecord: false,
  ...
  render() {
    ...
    const columns = [{
      ...
      title: '操作',
      dataIndex: 'operate',
      render: (text, row) => <Link to={`/main/UpgradePerfect/UpgradeApply/${row.key}`}>{text}</Link>,
    }];
    ...
    return (
      <div className="RetireDetail_stepsContent">
        <Form onSubmit={this.handleSubmit} style={{ width: '80%', marginLeft: '10%', minHeight: 500 }}>
          <div style={{ marginBottom: 20, marginTop: 40, marginLeft: '3%', width: '90%', height: 50, backgroundColor: '#edf7fc', lineHeight: '50px', paddingLeft: 20 }}>技术保障方案信息</div>
          <Row>
            <Col span={12}>
              <FormItem
                {...formItemLayout}
          ...
          <div style={{ marginBottom: 20, marginTop: 20, marginLeft: '3%', width: '90%', height: 50, backgroundColor: '#edf7fc', lineHeight: '50px', paddingLeft: 20 }}>技术方案提交信息</div>
          <Row>
            <Col span={12}>
              <FormItem
                {...formItemLayout}
        ...
        <div style={{ padding: 20, border: '1px solid #ccc', width: '80%', marginLeft: '10%', marginTop: 20 }}>
          <h2 style={{ margin: '20px 20px', display: 'inline-block' }}>升级完善申请列表</h2>
          <ButtonGroup>
        ...
        <div style={{ padding: 20, border: '1px solid #ccc', width: '80%', marginLeft: '10%', marginTop: 20 }}>
          <h2 style={{ margin: '20px 20px', display: 'inline-block' }}>升级完善方案详情</h2>
          <Table
            rowSelection={rowSelection}
...
UpgradeSchemeDetailFirstEdit.propTypes = {
  form: PropTypes.object.isRequired,
  newStatus: PropTypes.bool.isRequired,
  changeRead: PropTypes.func.isRequired,
};
const WrapUpgradeSchemeDetailFirstEdit = Form.create()(UpgradeSchemeDetailFirstEdit);
export default WrapUpgradeSchemeDetailFirstEdit;
