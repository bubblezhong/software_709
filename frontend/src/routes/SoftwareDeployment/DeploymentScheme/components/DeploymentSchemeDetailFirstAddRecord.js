...
class DeploymentSchemeDetailFirstAddRecord extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataSource: [{
...
DeploymentSchemeDetailFirstAddRecord.propTypes = {
  visible: PropTypes.bool.isRequired,
  handleCancel: PropTypes.func.isRequired,
};
export default DeploymentSchemeDetailFirstAddRecord;
