    ...
    return (
      <div className="InputDetail_stepsContent">
        <div style={{ overflow: 'hidden', width: '80%', marginLeft: '12%' }}>
          <Button style={{ float: 'right', width: 100, height: 40 }} type="primary" onClick={() => this.setState({ showTask: true })}>生出任务</Button>
        </div>
...
export default WrapDeploymentSchemeDetailFirstRead;
