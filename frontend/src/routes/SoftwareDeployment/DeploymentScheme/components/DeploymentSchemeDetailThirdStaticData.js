...
class DeploymentSchemeDetailThirdStaticData extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showRegister: false,
...
DeploymentSchemeDetailThirdStaticData.propTypes = {
  showTable: PropTypes.func.isRequired,
};
export default DeploymentSchemeDetailThirdStaticData;
