...
class DeploymentRequestDetailSecond extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: true,
    ...
    return (
      <div className="InputDetail_stepsContent">
        <Form onSubmit={this.handleSubmit} style={{ width: '80%', marginLeft: '10%', minHeight: 500 }}>
          <div style={{ marginBottom: 20, marginTop: 20, marginLeft: '3%', width: '90%', height: 50, backgroundColor: '#edf7fc', lineHeight: '50px', paddingLeft: 20 }}>调配审核处理</div>
          {this.props.disable ?
            <Row>
              <Col span={12}>
                <FormItem
...
DeploymentRequestDetailSecond.propTypes = {
  form: PropTypes.object.isRequired,
  disable: PropTypes.bool.isRequired,
};
const WrapDeploymentRequestDetailSecond = Form.create()(DeploymentRequestDetailSecond);
export default WrapDeploymentRequestDetailSecond;
