...
import SupportSchemeDetailFirstAddRecord from './SupportSchemeDetailFirstAddRecord';

const FormItem = Form.Item;
const Search = Input.Search;
const ButtonGroup = Button.Group;
class SupportSchemeDetailFirstEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
  ...
  render() {
    ...
    return (
      <div className="RetireDetail_stepsContent">
        ...
        <SupportSchemeDetailFirstAddRecord
...
SupportSchemeDetailFirstEdit.propTypes = {
  form: PropTypes.object.isRequired,
  newStatus: PropTypes.bool.isRequired,
  changeRead: PropTypes.func.isRequired,
};
const WrapSupportSchemeDetailFirstEdit = Form.create()(SupportSchemeDetailFirstEdit);
export default WrapSupportSchemeDetailFirstEdit;
