...
class SupportSchemeDetailThirdStaticData extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showRegister: false,
...
SupportSchemeDetailThirdStaticData.propTypes = {
  showTable: PropTypes.func.isRequired,
};
export default SupportSchemeDetailThirdStaticData;
