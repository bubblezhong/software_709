...
class OnlineHelp extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [{
  ...
  render() {
    const columns = [{
      ...
      title: '操作',
      dataIndex: 'detail',
      render: (text, row) => <Link to={`/main/TechnicalSupport/OnlineHelpDetail/${row.key}`}>{text}</Link>,
    }];
    const rowSelection = {
      ...
      <div>
        <div>
          <ButtonGroup style={{ marginBottom: 10 }}>
            ...
            <Link to="/main/TechnicalSupport/OnlineHelpDetailNew">
