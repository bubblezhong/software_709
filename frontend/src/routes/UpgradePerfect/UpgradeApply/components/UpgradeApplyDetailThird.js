...
class UpgradeApplyDetailThird extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      initialData: {
...
UpgradeApplyDetailThird.propTypes = {
  form: PropTypes.object.isRequired,
};
const WrapUpgradeApplyDetailThird = Form.create()(UpgradeApplyDetailThird);
export default WrapUpgradeApplyDetailThird;
