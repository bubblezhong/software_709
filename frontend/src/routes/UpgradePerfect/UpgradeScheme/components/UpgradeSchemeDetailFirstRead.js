...
class UpgradeSchemeDetailFirstRead extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      InitialData: {
  ...
  render() {
    ...
    const columns = [{
      ...
      title: '操作',
      dataIndex: 'operate',
      render: (text, row) => <Link to={`/main/UpgradePerfect/UpgradeApplyDetail/${row.key}`}>{text}</Link>,
    }];
...
UpgradeSchemeDetailFirstRead.propTypes = {
  // disable: PropTypes.bool.isRequired,
  // form: PropTypes.object.isRequired,
  changeEdit: PropTypes.func.isRequired,
};
export default UpgradeSchemeDetailFirstRead;
