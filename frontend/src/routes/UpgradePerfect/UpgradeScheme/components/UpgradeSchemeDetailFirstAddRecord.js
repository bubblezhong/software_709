...
class UpgradeSchemeDetailFirstAddRecord extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataSource: [{
...
UpgradeSchemeDetailFirstAddRecord.propTypes = {
  visible: PropTypes.bool.isRequired,
  handleCancel: PropTypes.func.isRequired,
};
export default UpgradeSchemeDetailFirstAddRecord;
