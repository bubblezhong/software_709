...
class CollectDetailEdit extends React.Component {
  constructor(props) {
    super(props);
    let id = 0;
  ...
  componentWillMount() {
    if (this.props.location.pathname === '/main/SoftwareDaily/CollectNew') {
  ...
  render() {
    ...
    let toWhere = '';
    if (this.props.params.id) {
      toWhere = `/main/SoftwareDaily/CollectDetail/${this.props.params.id}`;
      console.log('toWhere', toWhere);
    } else {
      toWhere = '/main/SoftwareDaily/Collect';
      console.log('toWhere', toWhere);
    }
    return (
      <div>
        <div style={{ overflow: 'auto', marginBottom: 20 }}>
          ...
          <Link to={`/main/SoftwareDaily/CollectDetail/${this.state.id}`}>
...
CollectDetailEdit.propTypes = {
  form: PropTypes.object.isRequired,
  location: PropTypes.object.isRequired,
  params: PropTypes.object.isRequired,
};
const WrapCollectDetailEdit = Form.create()(CollectDetailEdit);
export default WrapCollectDetailEdit;
