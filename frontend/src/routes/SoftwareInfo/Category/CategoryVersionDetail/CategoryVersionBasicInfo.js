...
import CategoryVersionTree from './../../../utils/CategoryVersionTree';
...
class SoftwareBasicInfo extends React.Component {
  constructor(props) {
    super(props);
    // console.log('/api/basic-software/use-category/', this.props);
    this.state = {
      basicInfo: [
    ...
    return (
      <div style={{ overflow: 'auto' }}>
        ...
        <div className="SoftwareBasicInfo_tree">
          <h2>软件组成单元</h2>
          <CategoryVersionTree id={this.props.params.id} data={data} />
        </div>
      </div>
    );
  }
